...
// AWSEC2LowCPURule flags running EC2 instances whose 30-day average CPU
...
func (r AWSEC2LowCPURule) ID() string   { return ec2LowCPURuleID }
func (r AWSEC2LowCPURule) Name() string { return "Low CPU EC2 Instance" }
